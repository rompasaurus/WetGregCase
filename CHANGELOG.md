...
## Current key dimensions (v28)

| | |
|---|---|
| Outer footprint | 102.6 × 46.6 mm (+X trimmed 1 mm past the USB) |
...
| Closure | flush lap + discrete snap beads (2/long wall + −X = 5; +X has none, trimmed); no added thickness |
