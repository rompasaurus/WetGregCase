...
## Current key dimensions (v27)

| | |
|---|---|
| Outer footprint | 103.6 × 46.6 mm (front = PCB + walls) |
...
| Closure | flush lap + discrete snap beads (2/long wall, −X, 2 flanking USB-C); no added thickness |
